...
CREATE OR REPLACE ROLE MLFLOW_SPCS_ROLE;
GRANT ROLE MLFLOW_SPCS_ROLE TO USER BOGHBOGH; -- Replace with your own USER
CREATE OR REPLACE DATABASE MAHDI_PLAYGROUND;
CREATE OR REPLACE SCHEMA MAHDI_PLAYGROUND.MLFLOW_TEST;
...
GRANT USAGE ON WAREHOUSE MLFLOW_TEST TO ROLE MLFLOW_SPCS_ROLE;
...
CREATE SERVICE MLFLOW_SNOWPARK
IN COMPUTE POOL MLFLOW_COMPUTE_POOL
    FROM @MLFLOW_STAGE
    specification_file='mflowspec.yaml'
    external_access_integrations = (ALLOW_ALL_EAI);

-- DROP SERVICE MLFLOW_SNOWPARK
-- ALTER SERVICE MLFLOW_SNOWPARK SUSPEND
-- ALTER SERVICE MLFLOW_SNOWPARK RESUME
